    ...
    <AppShell>
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            to="/sales"
            className="inline-flex items-center gap-2 rounded-lg bg-gradient-gold px-4 py-2.5 text-sm font-semibold text-primary-foreground shadow-luxury transition-transform hover:scale-[1.02]"
          >
            <Plus className="h-4 w-4" /> {t("actions.newSalesOrder")}
          </Link>
          <Link
            to="/inventory"
            className="inline-flex items-center gap-2 rounded-lg border border-primary/40 bg-card px-4 py-2.5 text-sm font-semibold text-primary transition-colors hover:bg-accent"
          >
          ...
          >
            <Users className="h-4 w-4" /> {t("actions.manageCustomers")}
          </Link>
        </div>
...
function Metric({
  ...
  return (
    <div
      className={`rounded-xl border p-5 shadow-card ${accent ? "border-primary/30 bg-gradient-to-br from-accent to-card" : "border-border bg-card"}`}
    >
      ...
      <div
        className={`mt-3 text-2xl font-bold tracking-tight ${accent ? "text-gradient-gold" : "text-foreground"}`}
      >
        {value}
      </div>
